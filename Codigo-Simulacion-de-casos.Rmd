...
caso1_1 <- limpiarMatriz(caso1[1:250,], indCol = T)$Resultado
caso1_2 <- limpiarMatriz(caso1[1:500,], indCol = T)$Resultado
caso1_3 <- limpiarMatriz(caso1[1:1000,], indCol = T)$Resultado
caso1_4 <- limpiarMatriz(caso1[1:2000,], indCol = T)$Resultado
